      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div className="space-y-4 text-sm">
            <Info label="EMAIL" value="ninep9p2006@gmail.com" />
            <Info label="PHONE" value="(+66) 88 557 8023" />
          ...
          <Link
            href="https://github.com/kritsasa"
            target="_blank"
            className="mt-8 inline-flex items-center gap-2 rounded-lg
                       ...
                       transition"
          >
            Go to GitHub <FaGithub size={20} />
          </Link>
        </div>

        {/* RIGHT */}
        <div className="relative flex justify-center">
          <div className="absolute w-72 h-72 md:w-96 md:h-96 rounded-full bg-emerald-500 -right-6 -top-6" />
          ...
          <Image
            ...
            width={384}
            height={384}
            className="relative w-72 h-72 md:w-96 md:h-96 rounded-full object-cover"
            priority
          />
        </div>
      </div>
